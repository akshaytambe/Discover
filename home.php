...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Escape Routine. Explore Places. Expand Your Circle.">
    <meta name="keywords" content="social network,social media,Discover,meet,free platform">
...
<a href="./u/<?php echo $_SESSION['Username']; ?>&ut=photos"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/photo-gallery.png" /> <?php echo lang('my_photos'); ?></p></a>
<a href="./settings"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/settings.png" /> <?php echo lang('settings'); ?></p></a>

<p class="homeLinks_title"><?php echo lang('my_notepad'); ?></p>
<a href="./mynotepad/new"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/new-note.jpg" /> <?php echo lang('new_note'); ?></p></a>
<?php
$msid = $_SESSION['id'];
$get_notes_sql="SELECT id,note_title FROM DiaryNotes WHERE author_id=:msid ORDER BY note_time DESC LIMIT 3";
...
?>
<a href="./mynotepad/"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/saved-notes.jpg" /> <?php echo lang('see_all_notes')."<span>".thousandsCurrencyFormat($notesCount)."</span>"; ?></p></a>

<p class="homeLinks_title"><?php echo lang('recently_starts_from'); ?></p>
<?php
$mYiD = $_SESSION['id'];
$getS_sql = "SELECT * FROM Favorite_Friend WHERE p_id =:mYiD ORDER BY id DESC LIMIT 5";
...
while ($getS_row = $getS->fetch(PDO::FETCH_ASSOC)) {
    ...
    $getuser_sql = "SELECT Username,Userphoto,Fullname FROM Users WHERE id=:getuserid";
...
?>
<a href="./u/<?php echo $_SESSION['Username']; ?>&ut=stars"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/all-activity.png" /> <?php echo lang('see_all_notes'); ?></p></a>

<p class="homeLinks_title"><?php echo lang('more'); ?></p>
<a href="./posts/saved"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/archive.png" /> <?php echo lang('saved_posts'); ?></p></a>
<a href="page/supportbox"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/support.png" /> <?php echo lang('supportBox'); ?></p></a>
<a href="page/report"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/feedback.png" /> <?php echo lang('Report_A_Problem'); ?></p></a>
    </div>
        </div>
    </div>
<!--======================[ end Center col1 ]=============================-->
            ...
            <div class="post">
                ...
                <div class="aSetup" align="center">
                    ...
                    <div class="aSetup_item">
                        <?php
                        $uid = $_SESSION['id'];
                        $sqlQ = "SELECT * FROM Following_Friends WHERE uf_one = :uid";
                        $sqlQ_check = $conn->prepare($sqlQ);
                        $sqlQ_check->bindParam(':uid',$uid,PDO::PARAM_INT);
                        $sqlQ_check->execute();
