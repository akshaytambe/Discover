...
<head>
    <title><?php echo "Hashtag - ".$_GET['tag'];if($_GET['tag'] == 'search'){echo "Hashtag";} ?> | Discover</title>
    <meta charset="UTF-8">
    ...
    <meta name="keywords" content="hashtag,social network,social media,Discover,meet,free platform">
...
$search_sql = "SELECT * FROM Post WHERE post_content LIKE ? AND p_privacy != ? AND p_privacy != ? ORDER BY post_time DESC LIMIT 8";
$params = array("%$q%", "1", "2");
