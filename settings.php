...
if (!password_verify($general_current_pass_var,$_SESSION['Password'])) {
    ...
    if (empty($fullname_var) or empty($username_var) or empty($email_var)) {
        ...
        $unExist = $conn->prepare("SELECT Username FROM Users WHERE Username =:username_var");
        ...
        $emExist = $conn->prepare("SELECT Email FROM Users WHERE Email =:email_var");
...
if (!password_verify($remeveA_current_pass_var,$_SESSION['Password'])) {
    $removeA_save_result = "<p class='alertRed'>".lang('current_password_is_incorrect')."</p>";
     ...
     $remeveAccount->execute();
     $remeveAccount_sql = "DELETE FROM Following_Friends WHERE uf_one= :myid";
     $remeveAccount = $conn->prepare($remeveAccount_sql);
     $remeveAccount->bindParam(':myid',$myid,PDO::PARAM_STR);
     $remeveAccount->execute();
     $remeveAccount_sql = "DELETE FROM Following_Friends WHERE uf_two= :myid";
     $remeveAccount = $conn->prepare($remeveAccount_sql);
     $remeveAccount->bindParam(':myid',$myid,PDO::PARAM_STR);
     $remeveAccount->execute();
     ...
     $remeveAccount->bindParam(':myid',$myid,PDO::PARAM_STR);
     $remeveAccount->execute();
     $remeveAccount_sql = "DELETE FROM DiaryNotes WHERE author_id= :myid";
     $remeveAccount = $conn->prepare($remeveAccount_sql);
     $remeveAccount->bindParam(':myid',$myid,PDO::PARAM_STR);
     $remeveAccount->execute();
     $remeveAccount_sql = "DELETE FROM Favorite_Friend WHERE u_id= :myid";
     $remeveAccount = $conn->prepare($remeveAccount_sql);
     $remeveAccount->bindParam(':myid',$myid,PDO::PARAM_STR);
     $remeveAccount->execute();
     $remeveAccount_sql = "DELETE FROM Favorite_Friend WHERE p_id= :myid";
     $remeveAccount = $conn->prepare($remeveAccount_sql);
     $remeveAccount->bindParam(':myid',$myid,PDO::PARAM_STR);
     $remeveAccount->execute();
     $remeveAccount_sql = "DELETE FROM Post WHERE author_id= :myid";
     $remeveAccount = $conn->prepare($remeveAccount_sql);
     $remeveAccount->bindParam(':myid',$myid,PDO::PARAM_STR);
     $remeveAccount->execute();
     ...
     $remeveAccount->bindParam(':myid',$myid,PDO::PARAM_STR);
     $remeveAccount->execute();
     $remeveAccount_sql = "DELETE FROM Saved_Post WHERE user_saved_id= :myid";
     $remeveAccount = $conn->prepare($remeveAccount_sql);
     $remeveAccount->bindParam(':myid',$myid,PDO::PARAM_STR);
     $remeveAccount->execute();
     $remeveAccount_sql = "DELETE FROM Feedback WHERE from_id= :myid";
     $remeveAccount = $conn->prepare($remeveAccount_sql);
     $remeveAccount->bindParam(':myid',$myid,PDO::PARAM_STR);
     $remeveAccount->execute();
...
<head>
    <title>Account settings | Discover</title>
    <meta charset="UTF-8">
    ...
    <meta name="keywords" content="settings,social network,social media,Discover,meet,free platform">
