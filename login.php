...
<head>
    <title><? echo lang('login'); ?> | Discover</title>
    <meta charset="UTF-8">
    ...
    <meta name="keywords" content="login,social network,social media,Discover,meet,free platform">
    ...
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
                <a href="index" class="login_signup_navbarLinks">Discover</a>
