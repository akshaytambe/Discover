...
$edit_post_location = trim(htmlspecialchars($_POST['pl']));
...
// ================= PDO sql query ===================================================
$edit_post_sql = "UPDATE Post SET post_content= :edit_post_var,p_title = :edit_post_title,p_location = :edit_post_location,p_privacy = :p_privacy WHERE post_id= :posts_id";
...
$edit_post->bindParam(':edit_post_location',$edit_post_location,PDO::PARAM_STR);
...
if (!empty($edit_post_location)) {
	$p_location = "$edit_post_location";
}else{
	$p_location = "";
}
switch ($p_privacy) {
