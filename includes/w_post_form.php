...
<div id="w_location" class="wpost_tabcontent">
<input type="text" name="w_location" maxlength="100" id="your_location" placeholder="<?php echo lang('w_location_inputText'); ?>" class="flat_solid_textfield"></input>
<input type="hidden" name="check_path" value="<?php echo $check_path; ?>" />
</div>
<div>
<ul class="wpost_tab">
    ...
    <li id="wt_location" style="float:<?php echo lang('w_post_li'); ?>;">
    <button class="wpost_tablinks" onclick="wpost_tabs(event, 'w_location')"><span style="color: #E53935;margin: 0px 5px;" class="fa fa-map-marker"></span> <?php echo lang('wpost_location'); ?></button>
    </li>
...
function init() {
    var input = document.getElementById('your_location');
