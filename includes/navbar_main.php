...
<nav class="navbar navbar-inverse" style="position:fixed;top:0;right:0;left:0;z-index: 2;">
    <div class="container-fluid" style="width: 1100px;">
        <div class="navbar-header" style="float: <?php echo lang('float'); ?>;">
            ...
            <!--class="navbar-brand"-->
            <a href="<?php echo $dircheckPath; ?>home"><img src="discover-text-home.png" alt="Discover" hspace="20"/></a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="<?php echo lang('ul_navbar_nav1'); ?>">
                ...
                ?>
                <li><a href="<?php echo $homePath; ?>" style="padding: 16px 10px;"><span style="font-size: 20px;" class="fa fa-home"></span> <?php #echo lang('navbar_home'); ?></a></li>
                <li><a href="javascript:void(0);" style="padding: 16px 10px;" id="nav_Noti_Btn"><span style="font-size: 20px;" class="fa fa-bell"></span><?php #echo lang('notifications'); ?><span id="notificationsCount"></span></a>
                ...
                <li><a href="<?php echo $dircheckPath; ?>messages/" style="padding: 16px 10px;"><span style="font-size: 20px;" class="fa fa-envelope"></span> <?php #echo lang('messages'); ?> <span id="messagesCount"></span></a>
                </li>
            </ul>
