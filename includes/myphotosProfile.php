...
$u_id = $row_id;
$emptyImg = '';
$getphotos_sql = "SELECT * FROM Post WHERE author_id=:u_id AND post_img != :emptyImg ORDER BY post_time DESC LIMIT 3";
...
$getphotos2_sql = "SELECT * FROM Post WHERE author_id=:u_id AND post_img != :emptyImg ORDER BY post_time";
