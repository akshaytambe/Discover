...
$p_privacy = "2";
$vpsql = "SELECT * FROM Post WHERE author_id IN 
(SELECT uf_two FROM Following_Friends WHERE uf_one=:s_id) AND p_privacy != :p_privacy OR author_id=:s_id ORDER BY post_time DESC LIMIT :plimit,10";
