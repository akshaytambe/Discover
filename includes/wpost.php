...
$p_location = filter_var(htmlspecialchars($_POST['w_location']), FILTER_SANITIZE_STRING);
...
$iptdbsql = "INSERT INTO Post
(post_id,author_id,post_img,post_time,post_content,p_title,p_location,p_privacy)
VALUES
( :post_id, :p_author_id, :p_img, :p_time, :p_content, :p_title, :p_location, :p_privacy)
";
...
$insert_post_toDB->bindParam(':p_location', $p_location,PDO::PARAM_STR);
...
$iptdbsql = "INSERT INTO Post
(post_id,author_id,post_time,post_content,p_title,p_location,p_privacy)
VALUES
( :post_id, :p_author_id, :p_time, :p_content, :p_title, :p_location, :p_privacy)
";
$insert_post_toDB = $conn->prepare($iptdbsql);
$insert_post_toDB->bindParam(':post_id', $post_id,PDO::PARAM_STR);
$insert_post_toDB->bindParam(':p_author_id', $p_author_id,PDO::PARAM_INT);
...
$vpsql = "SELECT * FROM Post WHERE post_id = :post_id";
