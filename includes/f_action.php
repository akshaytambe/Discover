...
$fid = "";
$checkfollow_sql = "SELECT * FROM Following_Friends WHERE uf_one=:s_id AND uf_two=:user_id";
...
if ($fchecknum > 0) {
    ...
    $unfollow_sql = "DELETE FROM Following_Friends WHERE uf_one=:s_id AND uf_two=:user_id";
    ...
    $followers_sql = "SELECT id FROM Following_Friends WHERE uf_two=:user_id";
    ...
    $follow_sql = "INSERT INTO Following_Friends VALUES (:fid,:s_id,:user_id)";
