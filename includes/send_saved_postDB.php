...
$checkExist_sql = "SELECT * FROM Saved_Post WHERE post_id= :pid AND user_saved_id= :myid";
...
if ($checkExist_count < 1) {
	$save_post_sql = "INSERT INTO Saved_Post (id, post_id, user_saved_id, saved_time) VALUES (:id, :pid, :myid, :st)";
