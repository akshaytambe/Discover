...
<head>
    <title><?php echo $row_username; ?> | Discover</title>
    <meta charset="UTF-8">
        ...
        <div class="profile_picture">
            ...
            <?php
               if($row_id != $_SESSION['id']){
                $csql = "SELECT id FROM Following_Friends WHERE uf_one=:s_id AND uf_two=:row_id";
                $c = $conn->prepare($csql);
                ...
                $sql = "SELECT id FROM Favorite_Friend WHERE u_id = :uid AND p_id =:pid";
...
<!--=============================================myphotos_section==================================================-->
            ...
            $u_id = $row_id;
            $emptyImg = '';
            $getphotos_sql = "SELECT * FROM Post WHERE author_id=:u_id AND post_img != :emptyImg ORDER BY post_time DESC";
...
<?php
$s_id = $_SESSION['id'];
$getfollowers_sql = "SELECT * FROM Following_Friends WHERE uf_two=:row_id";
...
$followBtn_sql = "SELECT id FROM Following_Friends WHERE uf_one=:s_id AND uf_two=:id_followers";
...
<?php
$s_id = $_SESSION['id'];
$getfolloweing_sql = "SELECT * FROM Following_Friends WHERE uf_one=:row_id";
...
$followBtn_sql = "SELECT id FROM Following_Friends WHERE uf_one=:s_id AND uf_two=:id_followeing";
$followBtn = $conn->prepare($followBtn_sql);
$followBtn->bindParam(':s_id',$s_id,PDO::PARAM_INT);
...
<?php
$s_id = $_SESSION['id'];
$getS_sql = "SELECT * FROM Favorite_Friend WHERE p_id =:row_id";
...
while ($getS_row = $getS->fetch(PDO::FETCH_ASSOC)) {
    ...
    while ($getuser_row = $getuser->fetch(PDO::FETCH_ASSOC)) {
        ...
        $followBtn_sql = "SELECT id FROM Following_Friends WHERE uf_one=:s_id AND uf_two=:id_stars";
        $followBtn = $conn->prepare($followBtn_sql);
        $followBtn->bindParam(':s_id',$s_id,PDO::PARAM_INT);
...
$s_id = $_SESSION['id'];
$emptyImg = '';
$getphotos_sql = "SELECT * FROM Post WHERE author_id=:s_id AND post_img != :emptyImg ORDER BY post_time";
$getphotos = $conn->prepare($getphotos_sql);
