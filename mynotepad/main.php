...
<head>
    <title><?php echo lang('my_notepad');?> | Discover</title>
    <meta charset="UTF-8">
...
<!--=============================[ Container ]=====================================-->
        ...
        <?php
$s_id = $_SESSION['id'];
$v_notes_sql = "SELECT * FROM DiaryNotes WHERE author_id= :s_id ORDER BY note_time DESC";
...
while ($v_notes_row = $v_notes->fetch(PDO::FETCH_ASSOC)) {
    ...
    if ($delete_note == $note_id) {
        $delete_s_note_sql = "DELETE FROM DiaryNotes WHERE id= :note_id";
